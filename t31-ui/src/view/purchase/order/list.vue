...
export default {
          ...
          render: (h, params) => {
            if (params.row.status) {
              ...
              return h('Button', {
                ...
                on: {
                  click: () => {
                    this.pay(params.row.id, params.row.money, params.row.startStationName, params.row.endStationName)
                  }
                },
                style: {
                  color: 'red'
  ...
  methods: {
    ...
    pay (outTradeNo, money, startStationName, endStationName) {
      this.$Modal.confirm({
        title: '确认支付',
        content: '确定要支付吗？',
        onOk: () => {
          instance.post(`/order/ali-pay/website-pay`,
            {
              ...
              'totalAmount': money,
              'subject': startStationName + '-' + endStationName + '-车票订单',
              'body': startStationName + '-' + endStationName
            }, {
              headers: {
